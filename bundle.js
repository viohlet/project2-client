...
/***/ function(module, exports, __webpack_require__) {
	...
	var showOtherButtons = function showOtherButtons() {
	  // $('.cambiopass').css('display', 'block');
	  $('.byescreen').css('display', 'block');
	};

	var hideLogInsButton = function hideLogInsButton() {
	...
	var showLogInButtons = function showLogInButtons() {
	  $('.hiscreen').css('display', 'block');
	  // $('#loginbutton').css('display', 'block');
	  // $('#signupbutton').css('display', 'block');
	};

	var hideOtherButtons = function hideOtherButtons() {
