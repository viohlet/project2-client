...
/***/ function(module, exports, __webpack_require__) {
	...
	var wizardEvents = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showWorkingArea = function showWorkingArea() {
	  $('#workingcontent').css('display', 'block');
	};

	var hideWorkingArea = function hideWorkingArea() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onHomeButton = function onHomeButton() {
	  document.getElementById("welcome-message").style.display = "block";
	  // document.getElementById(welcome-message).style.visibility = '';
	};

	var onHideHome = function onHideHome() {
	  document.getElementById("welcome-message").style.display = "none";
	};

	var onMyProjectsButton = function onMyProjectsButton() {
	  document.getElementById("workingcontent").style.display = "block";
	  onHideHome();
	};

	var onHideMyProjects = function onHideMyProjects() {
	  document.getElementById("workingcontent").style.display = "none";
	};

	var onNewProject = function onNewProject(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.newProject(data).done(ui.newProjectSuccess).fail(ui.failure);
	};

	var onGetProjects = function onGetProjects(data) {
	  event.preventDefault();
	  api.getProjects(data).done(ui.getProjectsSuccess).fail(ui.failure);
	};

	var onShowProject = function onShowProject(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.showProject(data).done(ui.success).fail(ui.failure);
	};
	...
	var updateId = function updateId(event) {
	  event.preventDefault();
	  var id = $(event.target).attr("data-project-id");
	...
	var onDeleteProject = function onDeleteProject(event) {
	  ...
	  api.deleteProject(id).done(ui.success).fail(ui.failure);
	...
	var onShowUserStories = function onShowUserStories() {
	  api.showUserStories().done(ui.showUserStoriesSuccess).fail(ui.failure);
	};

	var onCreateUserStory = function onCreateUserStory(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.newProject(data).done(ui.createUserStorySuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newProject = function newProject(data) {
	  console.log(data);
	  return $.ajax({
	...
	var showProject = function showProject(data) {
	...
	var showUserStories = function showUserStories(data) {
	  var user_story_id = data.user_story.id;
	  return $.ajax({
	...
	var createUserStory = function createUserStory(data) {
	  console.log(data);
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newProjectSuccess = function newProjectSuccess(data) {
	  // app.project = data.project;
	  console.log(data);
	};

	var showProjectsTemplate = __webpack_require__(12);

	var getProjectsSuccess = function getProjectsSuccess(projects) {
	  $('.title-display').html(showProjectsTemplate(projects));
	  console.log(projects);
	};

	var updateProjectSuccess = function updateProjectSuccess() {
	  clearInputField();
	  $('#updateProjectModal').modal('hide');
	};

	var showUserStoriesSuccess = function showUserStoriesSuccess(user_stories) {
	  var showUserStoriesTemplate = __webpack_require__(33);
	  $('.userstories-display').html(showUserStoriesTemplate(user_stories));
	  console.log(user_stories);
	};

	var createUserStorySuccess = function createUserStorySuccess(data) {
	  // app.project = data.project;
	  console.log(data);
	};
	...
	module.exports = {
	  ...
	  getProjectsSuccess: getProjectsSuccess,
	  updateProjectSuccess: updateProjectSuccess,
	  showUserStoriesSuccess: showUserStoriesSuccess,
	  createUserStorySuccess: createUserStorySuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"project-partial","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "\n\n<h2> Projects </h2>\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.projects : depth0), depth0),{"name":"projects","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<p class=\"project\">\n  <!-- Project #"
	    ...
	    + " -->\n\n  "
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "\n\n  <button class=\"optionsbtn btn-xs update-project\" data-toggle=\"modal\" data-target=\"#updateProjectModal\" data-project-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Edit Title</button>\n  <button class=\"deletebtn btn-xs delete-project\" data-toggle=\"modal\" data-target=\"#deleteProjectModal\" data-project-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Delete</button>\n  <!-- <button class=\"editdeletebtns btn-xs show-userstories\" data-target=\"#showeachsetofuserstories\" data-user_story-id= "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Delete</button> -->\n  <button id=\"showusbtn\" class=\"optionsbtn btn-xs show-userstories\" type=\"submit\" name=\"submit\" > Show User Stories </button>\n\n</p>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"user-stories-partial","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.userstories : depth0), depth0),{"name":"userstories","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "0ef0552b79f7896d546acd648fc84c06.jpg";
